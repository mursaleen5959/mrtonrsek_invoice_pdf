...
for ($i = 0; $i < 4; $i++) {
    ...
    *{$more[$i]}";
    ...
    $pdf->MultiCell(55, 2.3, iconv('UTF-8', 'windows-1252', $desc), 0, "L");
    ...
    $pdf->Image('images/'.$image[$i], $x + 55, $y + 1, 0, 10);
    $pdf->SetFont("PPL", "", "10");
    $x += 95;
...
switch ($payment) {
    case 'bank':
        $pdf->Cell(0, 20, "", 0, 1, 'C', $pdf->Image('src/Payment/bank-transfer.png', 20, $y - 15, 0, 70));
        break;
    case 'btc':
